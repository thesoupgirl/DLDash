...
@Component({
  selector: 'my-app',
  templateUrl: './projects.tags.component.html',
  styleUrls: [ './projects.tags.component.css' ]
})
export class TagComponent  {
  form: FormGroup;
    ...
    items = ['Javascript', 'Typescript', 'Bava'];
    subjects = ['Mathematics','Science','Computing','Art and Humanities','Languages','Personal Development'];

    items_2 = ['Lovo', 'Jovo', 'Bava'];
    inputText = 'text';

    itemsAsObjects = [{id: 0, name: 'Angular', readonly: true}, {id: 1, name: 'React'}];

    autocompleteItems = ['Mathematics','Science','Computing','Art and Humanities','Languages','Personal Development'];
    ...
    public requestAutocompleteItemsFake = (_text: string): Observable<string[]> => {
